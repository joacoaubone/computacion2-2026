    ...
    while not shutdown_event.is_set():
        ...
        for pid in pids:
            ...
            datos[pid] = {
                ...
                'faults_min': procfs.leer_stat(pid).get('min_flt', 0) if procfs.leer_stat(pid) else 0,
                'faults_maj': procfs.leer_stat(pid).get('maj_flt', 0) if procfs.leer_stat(pid) else 0,
                'maps': maps,
            }
